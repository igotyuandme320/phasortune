...
export function ParameterControlPanel({
  ...
  return (
    <div className="grid gap-3">
      ...
      <SliderControl label="电感量 L" subtitle="单位毫亨" min={1} max={500} step={1} value={inductanceMh} unit="mH" accent="purple" onChange={onInductanceChange} />
      <SliderControl label="电容量 C" subtitle="单位微法" min={1} max={1000} step={1} value={capacitanceUf} unit="µF" accent="cyan" onChange={onCapacitanceChange} />
    </div>
  );
}
