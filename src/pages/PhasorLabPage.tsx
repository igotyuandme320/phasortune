...
export function PhasorLabPage() {
  ...
  return (
    ...
    >
      <div className="mb-6">
        <p className="text-sm uppercase tracking-[0.2em] text-lab-cyan/80">Sinusoidal steady-state</p>
        <h1 className="mt-2 text-4xl font-black text-stone-50 sm:text-5xl">相量实验室 Phasor Lab</h1>
      ...
      <div className="grid gap-5 xl:grid-cols-[320px_minmax(0,1fr)_330px]">
        <GlassPanel className="h-fit p-4" delay={0.05}>
          <h2 className="mb-4 text-lg font-bold text-stone-50">参数控制 Controls</h2>
          ...
          <GlassPanel className="p-4 demo-emphasis" delay={0.12}>
            <div className="mb-4 flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-stone-400">Animated series circuit</p>
              </div>
        ...
        <GlassPanel className="h-fit p-4" delay={0.18}>
          <h2 className="mb-4 text-lg font-bold text-stone-50">实时计算 Live Values</h2>
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
        <GlassPanel className="p-4" delay={0.05}>
          <h2 className="mb-4 text-lg font-bold text-stone-50">核心公式 Formulas</h2>
        ...
        <GlassPanel className="p-4 demo-hide" delay={0.08}>
          <h2 className="mb-4 text-lg font-bold text-stone-50">课堂提示 Notes</h2>
          <div className="grid gap-3">
